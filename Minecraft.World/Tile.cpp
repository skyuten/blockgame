...
void Tile::staticCtor()
{
	...
	// 1.8.9
	Tile::dioriteBlock = (new StoneTile(161))->setDestroyTime(1.5f)->setExplodeable(10)->setSoundType(Tile::SOUND_STONE)->setIconName(L"diorite")->setDescriptionId(IDS_TILE_BLOCK_DIORITE)->setUseDescriptionId(IDS_DESC_BLOCK_DIORITE);
	// END
